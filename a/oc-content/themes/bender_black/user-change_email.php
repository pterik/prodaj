<?php
    ...
    function custom_meta_title($data){
        return __('Change e-mail', 'bender_black');;
    }
    osc_current_web_theme_path('header.php') ;
    $osc_user = osc_user();
?>
<h1><?php _e('Change e-mail', 'bender_black'); ?></h1>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('form#change-email').validate({
            ...
            messages: {
                new_email: {
                    required: '<?php echo osc_esc_js(__("Email: this field is required", "bender_black")); ?>.',
                    email: '<?php echo osc_esc_js(__("Invalid email address", "bender_black")); ?>.'
                }
            },
