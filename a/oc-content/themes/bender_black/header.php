...
<div id="header">
    ...
    <?php echo osc_get_preference('header-728x90', 'bender_black'); ?>
    <!-- /header ad 728x60-->
    </div>
    <div class="clear"></div>
    <div class="wrapper">
			<a href="<?php echo osc_base_url(true)?>?page=language&locale=uk_UK"><img src="<?php echo osc_current_web_theme_url('images/uk.png'); ?>" alt="UKR" width="24" height="16"></a><span id="flags"> UKR </span> 
			<a href="<?php echo osc_base_url(true)?>?page=language&locale=ru_RU"><img src="<?php echo osc_current_web_theme_url('images/ru.png'); ?>" alt="RUS" width="24" height="16"></a><span id="flags"> RUS </span>
			<a href="<?php echo osc_base_url(true)?>?page=language&locale=pl_PL"><img src="<?php echo osc_current_web_theme_url('images/pl.png'); ?>" alt="POL" width="24" height="16"></a><span id="flags"> POL </span>
        <div id="logo">
            <?php echo logo_header(); ?>
            <span id="description"><?php echo osc_page_description(osc_current_user_locale()); ?></span>
        </div>
        <ul class="nav">
    ...
    <form action="<?php echo osc_base_url(true); ?>" method="get" class="search nocsrf" <?php /* onsubmit="javascript:return doSearch();"*/ ?>>
        ...
        <div class="main-search">
            <div class="cell">
                <input type="text" name="sPattern" id="query" class="input-text" value="" placeholder="<?php echo osc_esc_html(__(osc_get_preference('keyword_placeholder', 'bender_black_theme'), 'bender_black')); ?>" />
            </div>
