...
<?php
    $js_lang = array(
        'delete' => __('Delete', 'bender_red'),
        'cancel' => __('Cancel', 'bender_red')
    );
...
<script type="text/javascript">
    ...
    bender_red.base_url = '<?php echo osc_base_url(true); ?>';
    bender_red.langs = <?php echo json_encode($js_lang); ?>;
    bender_red.fancybox_prev = '<?php echo osc_esc_js( __('Previous image','bender_red')) ?>';
    bender_red.fancybox_next = '<?php echo osc_esc_js( __('Next image','bender_red')) ?>';
    bender_red.fancybox_closeBtn = '<?php echo osc_esc_js( __('Close','bender_red')) ?>';
</script>
