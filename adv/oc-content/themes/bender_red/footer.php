    ...
    <div class="wrapper">
        <ul class="resp-toogle">
            ...
            <?php if( osc_is_web_user_logged_in() ) { ?>
                <li>
                    <?php echo sprintf(__('Hi %s', 'bender_red'), osc_logged_user_name() . '!'); ?>  &middot;
            ...
            <?php } else { ?>
                <li><a href="<?php echo osc_user_login_url(); ?>"><?php _e('Login', 'bender_red'); ?></a></li>
                <?php if(osc_user_registration_enabled()) { ?>
                    <li>
                        <a href="<?php echo osc_register_account_url(); ?>"><?php _e('Register for a free account', 'bender_red'); ?></a>
                    </li>
                <?php } ?>
            <?php } ?>
            <?php } ?>
            ...
            <li class="publish">
                <a href="<?php echo osc_item_post_url_in_category(); ?>"><?php _e("Publish your ad for free", 'bender_red');?></a>
            </li>
            <?php } ?>
        </ul>
        <ul>
        ...
        ?>
            <li>
                <a href="<?php echo osc_contact_url(); ?>"><?php _e('Contact', 'bender_red'); ?></a>
            </li>
        </ul>
        <?php
        if( osc_get_preference('footer_link', 'bender_red_theme') !== '0') {
        ...
        <?php if ( osc_count_web_enabled_locales() > 1) { ?>
            ...
            <strong><?php _e('Language:', 'bender_red'); ?></strong>
            <?php $i = 0;  ?>
