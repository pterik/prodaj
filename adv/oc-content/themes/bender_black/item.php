...
<div id="item-content">
    ...
    <?php if( osc_images_enabled_at_items() ) { ?>
        ...
        <div class="item-photos">
            <a href="<?php echo osc_resource_url(); ?>" class="main-photo" title="<?php _e('Image', 'bender_black'); ?> <?php echo $i+1;?> / <?php echo osc_count_item_resources();?>">
    ...
    <div id="useful_info" class="bordered-box">
        <h2><?php _e('Useful information', 'bender_black'); ?></h2>
        <ul>
    ...
    <?php if( osc_comments_enabled() ) { ?>
        ...
        <div id="comments">
            ...
            <?php if( osc_count_item_comments() >= 1 ) { ?>
                <div class="comments_list">
                    <?php while ( osc_has_item_comments() ) { ?>
                        <div class="comment">
                            <h3><strong><?php echo osc_comment_title(); ?></strong> <em><?php _e("by", 'bender_black'); ?> <?php echo osc_comment_author_name(); ?>:</em></h3>
            ...
            <div class="form-container form-horizontal">
                <div class="header">
                    <h3><?php _e('Leave your comment (spam and offensive messages will be removed)', 'bender_black'); ?></h3>
                </div>
                <div class="resp-wrapper">
                    <form action="<?php echo osc_base_url(true); ?>" method="post" name="comment_form" id="comment_form">
                        <fieldset>
                            ...
                            <?php }; ?>
                            <div class="control-group">
                                <label class="control-label" for="title"><?php _e('Title', 'bender_black'); ?></label>
                                <div class="controls">
                            ...
                            <div class="actions">
                                <button type="submit"><?php _e('Send', 'bender_black'); ?></button>
                            </div>
