    ...
    <div class="wrapper">
        <ul class="resp-toogle">
            ...
            <?php if( osc_is_web_user_logged_in() ) { ?>
                <li>
                    <?php echo sprintf(__('Hi %s', 'bender_black'), osc_logged_user_name() . '!'); ?>  &middot;
            ...
            <?php } else { ?>
                <li><a href="<?php echo osc_user_login_url(); ?>"><?php _e('Login', 'bender_black'); ?></a></li>
                <?php if(osc_user_registration_enabled()) { ?>
                    <li>
                        <a href="<?php echo osc_register_account_url(); ?>"><?php _e('Register for a free account', 'bender_black'); ?></a>
                    </li>
                <?php } ?>
            <?php } ?>
            <?php } ?>
        ...
        ?>
            <li>
                <a href="<?php echo osc_contact_url(); ?>"><?php _e('Contact', 'bender_black'); ?></a>
            </li>
        </ul>
        <?php
        if( osc_get_preference('footer_link', 'bender_black_theme') !== '0') {
        ...
        <?php if ( osc_count_web_enabled_locales() > 1) { ?>
            ...
            <strong><?php _e('Language:', 'bender_black'); ?></strong>
            <?php $i = 0;  ?>
