...
<div id="header">
    ...
    <div class="clear"></div>
    <div class="wrapper">
		<a href="<?php echo osc_base_url(true)?>?page=language&locale=uk_UK"> <img src="<?php echo osc_current_web_theme_url('images/uk.png'); ?>" alt="UKR" width="24" height="16"></a> UKR 
		<a href="<?php echo osc_base_url(true)?>?page=language&locale=ru_RU"> <img src="<?php echo osc_current_web_theme_url('images/ru.png'); ?>" alt="RUS" width="24" height="16"></a> RUS 
		<a href="<?php echo osc_base_url(true)?>?page=language&locale=pl_PL"> <img src="<?php echo osc_current_web_theme_url('images/pl.png'); ?>" alt="POL" width="24" height="16"></a> POL 
        <div id="logo">
