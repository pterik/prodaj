            ...
            <ul id="error_list"></ul>
                <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data" id="item-post">
                    ...
                    <?php } ?>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="title[<?php echo 'pl_PL'; ?>]"><?php _e('Title_pl_PL', 'bender_black'); ?></label>
                            <div class="controls">
                                <?php ItemForm::title_input('title','pl_PL', osc_esc_html( bender_black_item_title_lang('pl_PL') )); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="title[<?php echo 'ru_RU'; ?>]"><?php _e('Title_ru_RU', 'bender_black'); ?></label>
                            <div class="controls">
                                <?php ItemForm::title_input('title','ru_RU', osc_esc_html( bender_black_item_title_lang('ru_RU') )); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="title[<?php echo 'uk_UK'; ?>]"><?php _e('Title_uk_UK', 'bender_black'); ?></label>
                            <div class="controls">
                                <?php ItemForm::title_input('title','uk_UK', osc_esc_html( bender_black_item_title_lang('uk_UK') )); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="description[<?php echo 'pl_PL'; ?>]"><?php _e('Description_pl_PL', 'bender_black'); ?></label>
                            <div class="controls">
                                <?php ItemForm::description_textarea('description','pl_PL', osc_esc_html( bender_black_item_description_lang('pl_PL') )); ?>
                            </div>
						</div>
                        <div class="control-group">
                            <label class="control-label" for="description[<?php echo 'ru_RU'; ?>]"><?php _e('Description_ru_RU', 'bender_black'); ?></label>
                            <div class="controls">
                                <?php ItemForm::description_textarea('description','ru_RU', osc_esc_html( bender_black_item_description_lang('ru_RU') )); ?>
                            </div>
						</div>
                        <div class="control-group">
                            <label class="control-label" for="description[<?php echo 'uk_UK'; ?>]"><?php _e('Description_uk_UK', 'bender_black'); ?></label>
                            <div class="controls">
                                <?php ItemForm::description_textarea('description','uk_UK', osc_esc_html( bender_black_item_description_lang('uk_UK') )); ?>
                            </div>
						</div>
