<?php
    ...
    function custom_meta_title($data){
        return __('Update account', 'bender_black');
    }
...
<div class="form-container form-horizontal">
    <div class="resp-wrapper">
        ...
        <form action="<?php echo osc_base_url(true); ?>" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="phoneLand"><?php _e('Phone', 'bender_black'); ?></label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label"l for="address"><?php _e('Address', 'bender_black'); ?></label>
                <div class="controls">
                    <?php UserForm::address_text(osc_user()); ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="webSite"><?php _e('Website', 'bender_black'); ?></label>
                <div class="controls">
